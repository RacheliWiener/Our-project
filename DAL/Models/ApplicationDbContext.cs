...
public partial class ApplicationDbContext : DbContext
{
    ...
    public virtual DbSet<אריזתקרטון> אריזתקרטוןs { get; set; }

    public virtual DbSet<גלופות> גלופותs { get; set; }

    public virtual DbSet<הדבקתפורזץ> הדבקתפורזץs { get; set; }

    public virtual DbSet<הדפסה> הדפסהs { get; set; }

    public virtual DbSet<הטבעה> הטבעהs { get; set; }

    public virtual DbSet<הכנתסטים> הכנתסטיםs { get; set; }

    public virtual DbSet<הפקה> הפקהs { get; set; }

    public virtual DbSet<הצעתמחירהזמנה> הצעתמחירהזמנהs { get; set; }

    public virtual DbSet<השבחות> השבחותs { get; set; }

    public virtual DbSet<ייצורכריכהקשה> ייצורכריכהקשהs { get; set; }
    ...
    public virtual DbSet<מחירוןהדבקתפורזץ> מחירוןהדבקתפורזץs { get; set; }

    public virtual DbSet<מחירוןהדפסה> מחירוןהדפסהs { get; set; }

    public virtual DbSet<מחירוןהטבעה> מחירוןהטבעהs { get; set; }

    public virtual DbSet<מחירוןהשבחות> מחירוןהשבחותs { get; set; }

    public virtual DbSet<מחירוןייצורכריכהקשה> מחירוןייצורכריכהקשהs { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    {
        modelBuilder.Entity<אריזתקרטון>(entity =>
        {
        ...
        modelBuilder.Entity<הדבקתפורזץ>(entity =>
        {
        ...
        modelBuilder.Entity<הכנתסטים>(entity =>
        {
        ...
        modelBuilder.Entity<הצעתמחירהזמנה>(entity =>
        {
        ...
        modelBuilder.Entity<ייצורכריכהקשה>(entity =>
        {
        ...
        modelBuilder.Entity<מחירוןהדבקתפורזץ>(entity =>
        {
        ...
        modelBuilder.Entity<מחירוןהדפסה>(entity =>
        {
        ...
        modelBuilder.Entity<מחירוןהטבעה>(entity =>
        {
        ...
        modelBuilder.Entity<מחירוןייצורכריכהקשה>(entity =>
        {
